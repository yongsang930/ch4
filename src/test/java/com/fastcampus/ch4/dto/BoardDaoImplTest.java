...
public class BoardDaoImplTest {
    ...
    public void TestSearchSelectPage() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title" + i, "asdfasdfasdf" + i, "asdf" + i);
            boardDao.insert(boardDto);
        }
    ...
    @Test
    public void TestResultCntPage() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title" + i, "asdfasdfasdf" + i, "asdf" + i);
            boardDao.insert(boardDto);
    ...
    public void TestGetSearchResultCnt() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title" + i, "content" + i, "Tom");
    ...
    @Test
    public void TestGetSearchResultPage() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title" + i, "content" + i, "Tom");
            service.write(boardDto);
